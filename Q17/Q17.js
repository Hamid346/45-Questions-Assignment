var guests = ["Marie Curie", "Ali", "Thomas Edison", "Nikola Tesla", "Galileo Galilei"];
...
while (guests.length > 2) {
    ...
    console.log("Dear ".concat(removedGuest, ", I'm sorry to inform you that I can't invite you to dinner."));
}
for (var i = 0; i < guests.length; i++) {
    console.log("Dear ".concat(guests[i], ", you're still invited to dinner."));
}
